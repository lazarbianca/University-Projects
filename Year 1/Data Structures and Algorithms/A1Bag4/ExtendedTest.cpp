...
void testIteratorSteps(Bag& bag) {
	...
	while (bi.valid()) {
		count++;
		bi.next();
		//cout << "\n" << bi.getCount() << "	count: "<<count<<"	bagSize:" <<bag.size()<<"	" << bi.getCurrent() << "   "<<bi.getFrequency()<<'\n';
		//cout << "\n1. count: " << count<<"   bag: " << bag.size() << "\n";
	}
	//cout << count << "  " << bag.size();
...
//	while (bi.valid()) {
//		bi.next();
//		cout << "\n1. count: " << bi.getCount() << "   bag: " << bag.size() << "\n";
//	}
//	//cout << "count: " << bi.getCount() << "  Bag size: " << bag.size() << "\n";
//	assert(count == bag.size());
//}
