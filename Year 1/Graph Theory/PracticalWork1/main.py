...
def printMenu():
    ...
    print("14. Read graph from given textfile")
    print("15. Write (SAVE) graph to a textfile")
    print("16. Create random graph")
    print("\n17. Display connected components")
...
if __name__ == '__main__':
    ...
    while continueRun is True:
        ...
        if option == 0:
            ...
            # read graph from given textfile
            ...
            if 0 <= numberOfEdges <= (numberOfVertices * (numberOfVertices - 1))/2:  # divided by 2 for undirected graph
